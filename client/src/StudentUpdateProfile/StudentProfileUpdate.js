  ...
  const[studentInfo,setStudentInfo] = React.useState([{}])
    ...
    const validateInput = async event => {
      ...
      else
      {
        ...
        let address = addressValue;
         ...
         await fetch(`http://13.233.58.41:3001/update/${emailValue}`,{
    ...
    const AddEducation = async() => {
      let studentemail = emailValue;
        ...
        (async () =>
      {
          await fetch(`http://13.233.58.41:3001/AddStudentEducation`,{
        ...
        await delay(2000);
        navigate('/StudentProfile',{state:{email : studentemail}});
     })();
    }
    ...
    const AddExperience = async() => {
      let studentemail = emailValue;
        ...
        (async () =>
      {
          await fetch(`http://13.233.58.41:3001/AddStudentExperience`,{
    ...
    useEffect(() => {
      (async () =>
      {
        await fetch(`http://13.233.58.41:3001/profile/${emailValue}`).then(
